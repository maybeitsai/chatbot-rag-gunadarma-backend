...
class VectorStoreManager:
    ...
    def cleanup_old_collections(self, keep_latest: int = 2):
        ...
        try:
            ...
            if hasattr(app_manager, "cleanup_old_collections"):
                ...
                self.logger.info(
                    f"Cleaned up old collections, keeping {keep_latest} latest"
                )
            else:
                self.logger.warning(
                    "Cleanup method not available in app vector store manager"
                )
    ...
    def create_indexes(self):
        ...
        try:
            ...
            self.logger.warning(
                "App vector store manager not available for index creation"
            )
        except Exception as e:
    ...
    def get_vector_store_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if hasattr(app_manager, "get_vector_store_stats"):
                ...
                # Fallback stats
                return {"document_count": 0, "collection_count": 0, "status": "unknown"}
            ...
            return {"document_count": 0, "collection_count": 0, "status": "error"}
